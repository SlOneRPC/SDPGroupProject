...
public class ListBankAccount {
	...
	public void printAllAccounts(ArrayList<BankAccount> accounts) {
		/*
		 * for( int i = 0; accounts != null && i < accounts.size(); i++ ) { BankAccount
		 * account = accounts.get(i); System.out.println( "\taccountNumber: " +
		 * account.getAccountNumber() ); System.out.println( "\taccountType: " +
		 * account.toString() ); System.out.println( "\taccountVerified: " +
		 * account.getVerified() ); System.out.println( "\taccountBalance: " +
		 * account.getBalance() ); }
		 */
